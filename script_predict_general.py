...
bc.histogram_plot(df_days, "Représentation graphique des vélos par jour","TotalDays", 2800)
#566 lien
...
bc.sub_plot_days(df_days_mon,df_days_tues,df_days_wed,df_days_thur,df_days_fri,df_days_sa,df_days_sun,"TotalDays",2800)

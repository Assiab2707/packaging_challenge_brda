...
df_formated = bc.name_format(df)
df_formated = bc.drop_columns_useless(df_formated)
df_formated = bc.drop_na(df_formated)
df_formated = bc.format_date(df_formated)

df_days = df_formated.drop_duplicates("Date")
df_formated = bc.drop_columns_date(df_formated)

df_days = bc.drop_columns_date(df_days)
df_days = bc.total_days(df_days)
print(df_days)
# bc.histogram_plot(df_days)
#566 lien
...
# bc.histogram_plot(df_days_withoutwe)

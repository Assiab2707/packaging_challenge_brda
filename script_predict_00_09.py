...
print(summary)
bc.histogram_plot(df_09, "Représentation graphique de l'intensité du trafic entre 00h et 09h",
                  "TotalDateSinceMidnight", 675)

df_09_without_we = bc.subdf_withoutweekend(df_09)
bc.histogram_plot(df_09_without_we, "Représentation graphique de l'intensité du trafic entre 00h et 09h du lundi au vendredi",
                  "TotalDateSinceMidnight", 675)
